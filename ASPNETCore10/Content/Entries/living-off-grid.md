---
title: "Living off-grid with a family of nine: what we gave up, and what we didn't. " 
slug: living-off-grid
date: 2026-03-01
...
::: callout
**The well pump surprise:** Our single biggest electrical load last winter was not the HVAC — it was the well pump. Without a storage tank to buffer demand, the pump cycles on every time house pressure drops, drawing 2.45 MWh this past winter. Both heat pump systems combined drew 2.24 MWh last year and 2.70 MWh the year before. Heating the house costs the same as drawing water. If you're designing an off-grid home with a well, a pump-to-storage-tank strategy or using a standard pump with a 60/40 switch rather than VFD can meaningfully reduce this load, perhaps by half.
::: 
